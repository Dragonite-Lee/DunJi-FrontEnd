...
function StudentAuth() {
  ...
  const schoolOnchangeHandler = useCallback(
      ...
      <div className="flex items-center flex-col pt-56">
        <div className="flex flex-col items-center">
          ...
          <div className="text-center mt-12 text-[14px] Pretendard-Regular leading-7">
            간편하게 로그인하고 <br />
            <span className="Pretendard-SemiBold">둥지의 다양한 서비스를</span>
            이용하세요
          </div>
        </div>
      </div>
      ...
      <div className="px-[18px] mt-24">
        <div className="flex items-center">
          ...
          <select
            name="usermail"
            defaultValue="0"
            className="Pretendard-Regular text-xl pl-4 w-3/4 h-[50px] rounded-standard_rounded"
            onChange={(e) => schoolOnchangeHandler(e)}
          >
        ...
        <div className="flex items-center mt-3">
          ...
          <input
            type="text"
            placeholder="이메일 주소"
            className="Pretendard-Regular text-xl pl-4 w-2/5 h-[50px] rounded-standard_rounded mr-[10px]"
            onChange={(e) => emailOnchangeHandler1(e)}
          />
          <select
            name="usermail"
            defaultValue="0"
            className="Pretendard-Regular text-xl pl-4 w-2/5 h-[50px] rounded-standard_rounded"
            onChange={(e) => emailOnchangeHandler2(e)}
          >
            <option value="0">선택</option>
          ...
          <div>
            <div className="flex items-center mt-12">
              <input
                ...
                className="Pretendard-Regular text-xl pl-4 w-3/5 h-[50px] rounded-standard_rounded"
                onChange={(e) => authNumberOnchangeHanlder(e)}
              />
              <div className="Pretendard-SemiBold text-xl pl-3">
                {authTimeMin}:{authTimeSec}
              </div>
              <div
                className="w-2/5 Pretendard-SemiBold text-2xl text-center underline"
                onClick={studentAuthAgain}
              >
                재전송
              </div>
            </div>

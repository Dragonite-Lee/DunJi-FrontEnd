...
function BottomNextBtn() {
  ...
  const checkHandler = async () => {
    ...
    for (let i = 0; i < manageArr.length; i++)
      formData.append(manageArr[i], state['manageSelect'][i]);
    ...
    for (let i = 0; i < optionArr.length; i++)
      formData.append(optionArr[i], state['option'][i]);

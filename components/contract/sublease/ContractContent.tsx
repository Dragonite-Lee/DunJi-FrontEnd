...
export default function ContractContent() {
    ...
    return (
        <div className="h-full px-[18px]">
            {/* 전대동의서 확인 */}
            <div
                className="Pretendard-SemiBold py-12 px-[18px] mt-10 bg-white rounded-standard_rounded rounded-b-none border-b-2 border-background_beige h-room_register_btn_height1 text-[17px] flex justify-between items-center" 
            >
            ...
            { openModal1 === true  && (
                <div className="Pretendard-Regular py-4 px-[18px] bg-white text-xl">
                    <div className="my-2">
                        1) 전대인(매물을 올린사람)이 집주인에게 매물 올리는 것을
                        허락 받았는지 확인해야합니다. <span className="underline">전대 동의서</span>를 받으세요!
                    </div>
                    <div className="text-font_gray mt-6 text-xl">
                        <span className="font-bold">*전대동의서:</span> 전대 사용에 대한 동의 사실을 기재한 문서
                    ...
                    <div className="text-font_gray mt-6 text-xl">
                        <span className="font-bold">*임대인과 임차인:</span> 집주인과 매물 올린 사람의 관계<br />
                        <span className="font-bold">*전대인과 전차인:</span> 매물 올린 사람과 매물 구하는 사람
                    </div>
                    <div className="mt-6">
            ...
            { openModal2 === true  && (
                <div className="Pretendard-Regular py-4 px-[18px] bg-white text-xl">
                    <div className="my-2">
                        1) 전대인(매물 올린 사람)이 집주인과 작성했던 임대차 계약 서를 확인하세요!
                    </div>
                    <div className="mt-6">
                        2) 전대인(매물 올린 사람)이 해당 매물 글에 입주가능기간을 임대차 계약 만료 기간(매물 올린 사람의 계약 만료 기간)을 넘게 제시하지는 않았는지 확인하세요! 
                    </div>
                    <div className="mt-6">
            ...
            { openModal3 === true  && (
                <div className="Pretendard-Regular py-4 px-[18px] bg-white text-xl">
                    <div className="my-2">
                        1) 임대차 계약서에 작성되어 있는 집주인과 전대인(매물 올 린 사람)의 주민등록번호를 포함한 신상을 신분증과 대조해 보고 해당 건물이 집주인 명의가 맞는지 등기부등본을 확인 하세요!
                    </div>
                </div>
            )}
            {/* 전대차계약서 작성 */}

...
function BottomNextBtnLayout({
  state,
  content,
  onClick,
}: BottomNextBtnLayoutProps) {
  return (
    <div>
      {state ? (
        <div
        ...
        <div className="min-w-[375px] sm:w-[375px] sm:m-auto bg-font_gray fixed bottom-0 w-screen flex flex-col items-center h-20 justify-around">

            ...
            <div className="flex items-center">
                ...
                <div>
                    ...
                    <div className="flex items-center mb-[3px]">
                        <div className="text-[17px] Pretendard-SemiBold pr-[5px] ">둥지인</div>
                        <div className="text-[10px] text-font_gray mt-auto Pretendard-Regular border border-border_color rounded-[7px] px-[7px] py-[3px]">한양대에리카</div>
                    </div>

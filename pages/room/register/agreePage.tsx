            ...
            <div className="pb-[105px] mx-[17px] mt-[25px]">
                ...
                <div className="mt-[16px] Pretendard-Regular text-[15px]">
                    <div className="flex items-center justify-between">
                        <div>
                            방 등록에 대해 집주인의 동의 및 동의 서면을 얻었음
                        </div>
                        <input id="check1" type="checkbox" checked={isCheck1} onChange={() => {ChangeHandler(SetIsCheck1)}} />
                    </div>
                    <div className="flex items-center justify-between">
                        <div>
                        방 등록에 대한 모든 책임은 당사자에게 있음을 확인하고 동의함
                        </div>
                        <input id="check2" type="checkbox" checked={isCheck2} onChange={() => {ChangeHandler(SetIsCheck2)}} />
                    </div>
                </div>
            </div>
            {isCheck1 && isCheck2 ? (
